...
<body>
    ...
    <div style="margin-top: 40px; border-top: 1px solid #ddd; padding-top: 10px; font-size: 11px; color: #666; text-align: right;">
        <p style="margin: 0 0 3px 0;">Dicetak pada: {{ \Carbon\Carbon::now()->format('d F Y H:i') }}</p>
