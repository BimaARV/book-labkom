...
@section('title', 'Halaman Tidak Ditemukan | Techub')
...
<main class="container py-5 d-flex flex-column justify-content-center align-items-center flex-grow-1 text-center">
    ...
    <div class="mb-4">
        <i class="bi bi-compass text-primary" style="font-size: 5rem;"></i>
    </div>
    <h1 class="fw-bold mb-3 display-4">404</h1>
    <h2 class="fw-semibold mb-3">Halaman Tidak Ditemukan</h2>
    <p class="text-muted-custom mb-5 fs-5 max-w-md mx-auto" style="max-width: 600px;">
        Maaf, halaman yang Anda cari tidak ada atau telah dipindahkan. Silakan periksa kembali URL yang dimasukkan atau kembali ke Halaman Utama.
    </p>
