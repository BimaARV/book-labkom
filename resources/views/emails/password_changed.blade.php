...
<body>
    <div class="container">
        <div class="header">
            <h2 style="font-size: 1.25rem;">Password Berhasil Diubah</h2>
            <p style="margin:0; opacity: 0.8; font-size: 0.9rem;">Techub</p>
        </div>
        <div class="content">
            <p>Halo,</p>
            <p>Kami ingin menginformasikan bahwa password untuk akun Anda baru saja berhasil diubah.</p>
            <p>Jika Anda merasa tidak melakukan perubahan ini, segera hubungi tim administrator untuk mengamankan akun Anda.</p>
